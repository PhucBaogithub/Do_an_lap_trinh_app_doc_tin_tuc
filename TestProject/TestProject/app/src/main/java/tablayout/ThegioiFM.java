...
public class ThegioiFM extends Fragment {

    private RecyclerView rcvNewsThegioi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_thegioi_f_m, container, false);
        rcvNewsThegioi=view.findViewById(R.id.rcv_newsThegioi);
        ...
        rcvNewsThegioi.setLayoutManager(linearLayoutManager);
        rcvNewsThegioi.setAdapter(newsAdapter);

        //set sự kiện ẩn nav
        RecyclerView.ItemDecoration itemDecoration = new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL);
        rcvNewsThegioi.addItemDecoration(itemDecoration);
        rcvNewsThegioi.setOnTouchListener(new TranslateAnimationUtil(getContext(), MainActivity.bottomNavigationView));
        return view;
    }
    ...
    private List<News> getListNews() {
        ...
        Cursor cursor = dbHelper.readAllDataNewsGlobal();
