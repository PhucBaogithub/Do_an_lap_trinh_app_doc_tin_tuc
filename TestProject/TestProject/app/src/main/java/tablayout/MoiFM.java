...
public class MoiFM extends Fragment {

    private RecyclerView rcvNewsMoi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_moi_f_m, container, false);
        rcvNewsMoi=view.findViewById(R.id.rcv_newsMoi);
        ...
        rcvNewsMoi.setLayoutManager(linearLayoutManager);
        rcvNewsMoi.setAdapter(newsAdapter);

        //set sự kiện ẩn nav
        RecyclerView.ItemDecoration itemDecoration = new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL);
        rcvNewsMoi.addItemDecoration(itemDecoration);
        rcvNewsMoi.setOnTouchListener(new TranslateAnimationUtil(getContext(), MainActivity.bottomNavigationView));
        return view;
    }
    ...
    private List<News> getListNews() {
        ...
        Cursor cursor = dbHelper.readAllDataNewsNew();
