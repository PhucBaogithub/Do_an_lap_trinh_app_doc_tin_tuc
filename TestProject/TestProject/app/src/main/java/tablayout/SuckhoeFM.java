...
public class SuckhoeFM extends Fragment {

    private RecyclerView rcvNewsSuckhoe;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_suckhoe_f_m, container, false);
        rcvNewsSuckhoe=view.findViewById(R.id.rcv_newsSuckhoe);
        ...
        rcvNewsSuckhoe.setLayoutManager(linearLayoutManager);
        rcvNewsSuckhoe.setAdapter(newsAdapter);

        //set sự kiện ẩn nav
        RecyclerView.ItemDecoration itemDecoration = new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL);
        rcvNewsSuckhoe.addItemDecoration(itemDecoration);
        rcvNewsSuckhoe.setOnTouchListener(new TranslateAnimationUtil(getContext(), MainActivity.bottomNavigationView));
        return view;
    }
    ...
    private List<News> getListNews() {
        ...
        Cursor cursor = dbHelper.readAllDataNewsHealth();
