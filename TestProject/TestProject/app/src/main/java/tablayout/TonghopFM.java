...
public class TonghopFM extends Fragment {

    private RecyclerView rcvNewsTonghop;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tonghop_f_m, container, false);
        rcvNewsTonghop=view.findViewById(R.id.rcv_newsTonghop);
        ...
        rcvNewsTonghop.setLayoutManager(linearLayoutManager);
        rcvNewsTonghop.setAdapter(newsAdapter);

        //set sự kiện ẩn nav
        RecyclerView.ItemDecoration itemDecoration = new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL);
        rcvNewsTonghop.addItemDecoration(itemDecoration);
        rcvNewsTonghop.setOnTouchListener(new TranslateAnimationUtil(getContext(), MainActivity.bottomNavigationView));
        return view;
    }
