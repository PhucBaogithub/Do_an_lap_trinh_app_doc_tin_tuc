...
public class CongngheFM extends Fragment {

    private RecyclerView rcvNewsCongnghe;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_congnghe_f_m, container, false);
        rcvNewsCongnghe=view.findViewById(R.id.rcv_newsCongnghe);
        ...
        rcvNewsCongnghe.setLayoutManager(linearLayoutManager);
        rcvNewsCongnghe.setAdapter(newsAdapter);

        //set sự kiện ẩn nav
        RecyclerView.ItemDecoration itemDecoration = new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL);
        rcvNewsCongnghe.addItemDecoration(itemDecoration);
        rcvNewsCongnghe.setOnTouchListener(new TranslateAnimationUtil(getContext(), MainActivity.bottomNavigationView));
        return view;
    }
    ...
    private List<News> getListNews() {
        ...
        Cursor cursor = dbHelper.readAllDataNewsTechnology();
