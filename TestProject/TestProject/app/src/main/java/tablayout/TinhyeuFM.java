...
public class TinhyeuFM extends Fragment {

    private RecyclerView rcvNewsTinhyeu;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tinhyeu_f_m, container, false);
        rcvNewsTinhyeu=view.findViewById(R.id.rcv_newsTinhyeu);
        ...
        rcvNewsTinhyeu.setLayoutManager(linearLayoutManager);
        rcvNewsTinhyeu.setAdapter(newsAdapter);

        //set sự kiện ẩn nav
        RecyclerView.ItemDecoration itemDecoration = new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL);
        rcvNewsTinhyeu.addItemDecoration(itemDecoration);
        rcvNewsTinhyeu.setOnTouchListener(new TranslateAnimationUtil(getContext(), MainActivity.bottomNavigationView));
        return view;
    }
    ...
    private List<News> getListNews() {
        ...
        Cursor cursor = dbHelper.readAllDataNewsLove();
