...
public class XeFM extends Fragment {

    private RecyclerView rcvNewsXe;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_xe_f_m, container, false);
        rcvNewsXe=view.findViewById(R.id.rcv_newsXe);
        ...
        rcvNewsXe.setLayoutManager(linearLayoutManager);
        rcvNewsXe.setAdapter(newsAdapter);

        //set sự kiện ẩn nav
        RecyclerView.ItemDecoration itemDecoration = new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL);
        rcvNewsXe.addItemDecoration(itemDecoration);
        rcvNewsXe.setOnTouchListener(new TranslateAnimationUtil(getContext(), MainActivity.bottomNavigationView));
        return view;
    }
    ...
    private List<News> getListNews() {
        ...
        Cursor cursor = dbHelper.readAllDataNewsCar();
